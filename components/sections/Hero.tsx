    ...
    >
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1fr_auto] lg:gap-16">
        ...
        <motion.div
          ...
          className="mx-auto flex justify-center lg:mx-0"
        >
          <div className="relative">
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-accent/30 to-accent/5 blur-xl" />
            <div className="relative h-56 w-56 overflow-hidden rounded-full border-4 border-card shadow-xl ring-2 ring-border ring-offset-2 ring-offset-background md:h-72 md:w-72">
              <Image
